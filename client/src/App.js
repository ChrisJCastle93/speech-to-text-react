  ...
  return (
    <ChakraProvider>
      {loading ? (
        ...
        <div className="App">
          <Navbar loggedInUser={loggedInUser} logoutHandler={logoutHandler} handleSearchResults={handleSearchResults} />
          ...
          <Routes>
            ...
            <Route path="/cart" element={<Cart loggedInUser={loggedInUser} setIsComingFromCart={setIsComingFromCart} />} />
            ...
            <Route path="/login" element={<Login isComingFromCart={isComingFromCart} setLoggedInUser={setLoggedInUser} />} />
